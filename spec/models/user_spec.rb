...
describe User do
  ...
  it "should require an email address" do
    no_name_user = User.create(@attr.merge(:email=>""))
    no_name_user.should_not be_valid
  end

  it "should reject long names" do
    long_name = 'a' * 51
    no_name_user = User.create(@attr.merge(:name=>long_name))
    no_name_user.should_not be_valid
  end

  it "accept valid email addresses" do
    addresses = %w[user@foo.com THE.user@bar.org another_user@foo.bar.bash.net]
  ...
  it "reject invalid email addresses" do
    addresses = %w[user_foo.com a@b THE.user-bar.org another.user.foo.bar.bash@net]
    addresses.each do |address|
      valid_email_user = User.new(@attr.merge( :email => address ))
  ...
  describe "password_encryption" do
    ...
    describe "authenticate method" do
      ...
      it "should return nil for an email address with no user" do
        nonexistent_user = User.authenticate("invalid@user.com", @attr[:password])
